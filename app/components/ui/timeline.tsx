          ...
          ({ title, subtitle, description, dates, image, gpa, link }, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="sm:h-20 sm:w-20 w-16 h-16 shadow-lg shadow-slate-800 absolute lg:left-1/2 transform lg:-translate-x-1/2 flex items-center justify-center p-2 border-2 border-sjsu-gold rounded-full">
                    <Image
                      src={image}
                      alt={subtitle}
